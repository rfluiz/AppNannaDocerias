...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async{
    ...
    response = await http.get("https://api.giphy.com/v1/gifs/trending?api_key=nBEFgZ6PwRISDCuzQv2bPfOVPNh86VqD&limit=20&rating=g");
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=nBEFgZ6PwRISDCuzQv2bPfOVPNh86VqD&q=$_search&limit=19&offset=$_offSet&rating=g&lang=en");
